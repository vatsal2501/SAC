			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<div class="card">
							<h5 class="card-header">Process Details</h5>
							<hr class="my-0" />
							<div class=" text-nowrap m-3">
								<table id="example"
									...
									<tbody class="table-border-bottom-0">
										<c:forEach items="${progressOrderVOList}" var="i" varStatus="j">
											<tr>
												<td></td>
												<td><input type="checkbox" name=""></td>
												<td>${j.count}</td>
												<td>${i.orderVO.orderId }</td>
												...
												<td>${i.orderVO.orderQuantity}</td>
												<td>${i.clientReqVO.decal}</td>
												<td>${i.clientReqVO.cutting}</td>
												<td>${i.clientReqVO.printing}</td>
												<td>
													<div class="d-flex align-items-center">
														<a data-toggle="tooltip" data-placement="top"
															title="Edit ClientReq" data-original-title="Edit"
															href="editProcess?id=${i.processId}"><i
															class="bx bx-edit"></i></a> <a data-toggle="tooltip"
															data-placement="top" title="Delete ClientReq"
															data-original-title="Delete"
															href="deleteProcess?id=${i.processId}"><i
