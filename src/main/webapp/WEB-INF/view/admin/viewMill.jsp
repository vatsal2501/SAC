			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<div class="card">
							<h5 class="card-header">Mill Details</h5>
							<hr class="my-0"/>
							<div class=" text-nowrap m-3">
								<table id="example"
									...
									<tbody class="table-border-bottom-0">
										<c:forEach items="${millList}" var="i" varStatus="j">
											<tr>
												<td></td>
												...
												<td>${i.millName}</td>
												<td>${i.millAddress}</td>
												<td>${i.millMobileNumber}</td>
												<td>${i.millGSTNumber}</td>
												<td>
													<div class="d-flex align-items-center">
														<a data-toggle="tooltip" data-placement="top"
															title="Edit Mill" data-original-title="Edit"
															href="editMillName?id=${i.millId}"><i class="bx bx-edit"></i></a>
														<a data-toggle="tooltip" data-placement="top"
															title="Delete Mill" data-original-title="Delete"
															href="deleteMillName?id=${i.millId}"><i
