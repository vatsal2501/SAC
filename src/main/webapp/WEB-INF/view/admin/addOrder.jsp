									...
									<div class="row">
										...
										<div class="mb-3 col-md-4">
											...
											<f:select path="clientReqVO.clientreqId" class="form-select" id="clientItems" onchange="getItemsDetailsByClientItem()">
												<c:forEach items="${clientreqList}" var="i">
													<f:option value="${i.clientreqId}">${i.clientItems}</f:option>
												</c:forEach>
											</f:select>
										</div>

										<div class="mb-3 col-md-4">
											<label for="length" class="form-label">Length</label> <input value="${orderVO.clientReqVO.length}"
												type="text" id="length" class="form-control"  name="length" style="background-color: #E5E4E2" >
										</div>
									</div>
									<div class="row">
										<div class="mb-3 col-md-4">
											<label for="width" class="form-label">Width</label> <input value="${orderVO.clientReqVO.width}"
												type="text" id="width" class="form-control"  name="width" style="background-color: #E5E4E2" >
										</div>


										<div class="mb-3 col-md-4">
											<label for="height" class="form-label">Height</label> <input value="${orderVO.clientReqVO.height}"
												type="text" id="height" class="form-control" name="height" style="background-color: #E5E4E2">
										</div>
