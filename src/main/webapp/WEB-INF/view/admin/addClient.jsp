...
<body>
				...
				<div class="container-xxl flex-grow-1 container-p-y">
					<div class="col-xxl">
						<div class="card mb-4">
							...
							<div class="card-body">
								<f:form action="insertClient" method="post"
									modelAttribute="clientVO" id="clientvalidate">
									<div class="row mb-3">
										<label class="col-sm-2 col-form-label" for="clientName">Client
											Name<span style="color: red">*</span>
										</label>
										<div class="col-sm-10">
											<f:input path="clientName" cssClass="form-control"
												id="clientName" />

										</div>
									</div>
									<div class="row mb-3">
										<label class="col-sm-2 col-form-label" for="clientAddress">Address<span
											style="color: red">*</span></label>
										<div class="col-sm-10">
												<f:textarea path="clientAddress" cssClass="form-control"
													id="clientAddress" />
										</div>
									</div>
									<div class="row mb-3">
										<label class="col-sm-2 col-form-label" for="pinCode">Pin
											Code<span style="color: red">*</span>
										</label>
										<div class="col-sm-10">
												
												<f:input path="pinCode" cssClass="form-control" id="pinCode" />
										</div>
									</div>
									<div class="row mb-3">
										<label class="col-sm-2 col-form-label" for="clientMobileNumber">Mobile
											Number<span style="color: red">*</span>
										</label>
										<div class="col-sm-10">
												
												<f:input path="clientMobileNumber" cssClass="form-control"
													id="clientMobileNumber" />
										</div>
									</div>

									<div class="row mb-3">
										<label class="col-sm-2 col-form-label" for="clientGSTNumber">GST
											Number<span style="color: red">*</span>
										</label>
										<div class="col-sm-10">
												<f:input path="clientGSTNumber" cssClass="form-control"
													id="clientGSTNumber" />
										</div>
									</div>
	...
	<script
		src="<%=request.getContextPath()%>/adminResources/js/clientvalidation.js"></script>
</body>
</html>
