			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						...
						<div class="card">
							<h5 class="card-header">Reel Details</h5>
							<hr class="my-0"/>
												...
												<td>
													<div class="d-flex align-items-center">
														<a data-toggle="tooltip" data-placement="top"
															title="Edit Reel" data-original-title="Edit"
															href="editReel?id=${i.reelId}"><i class="bx bx-edit"></i></a>
														<a data-toggle="tooltip" data-placement="top"
															title="Delete Reel" data-original-title="Delete"
															href="deleteReel?id=${i.reelId}"><i
