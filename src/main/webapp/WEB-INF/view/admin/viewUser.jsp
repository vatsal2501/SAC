										...
										<c:forEach items="${userList}" var="i" varStatus="j">
											<tr>
												...
												<td>
													<div class="d-flex align-items-center">
														...
														<a data-toggle="tooltip" data-placement="top"
															title="Edit User" data-original-title="Edit" href="editUser?id=${i.id}"><i
															class="bx bx-edit"></i></a> <a data-toggle="tooltip"
															data-placement="top" title="Delete User"
															data-original-title="Delete" href="deleteUser?id=${i.id}"><i
												...
												<div class="d-flex align-items-center">
															...
															title="Enable" data-original-title="Enable"
															href="#"><button type="button"
																class="btn btn-sm btn-outline-success">
																<span class="tf-icons bx bx-check"></span>&nbsp; Enable
															</button></a> 
															<a data-toggle="tooltip" data-placement="top"
															...
															<button type="button"
																...
																<span class="tf-icons bx bx-block"></span>&nbsp; Disable
															</button>
														</a>
