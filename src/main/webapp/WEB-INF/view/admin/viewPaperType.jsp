...
<title>Admin | View PaperType</title>
			...
			<div class="layout-page">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<div class="card">
							<h5 class="card-header">Paper Type Details</h5>
							<hr class="my-0"/>
						<div class=" text-nowrap m-3">
								<table id="example"
									...
									<c:forEach items="${PaperTypeList}" var="i" varStatus="j">
											...
											<tr><td></td>
												...
												<div class="d-flex align-items-center">
													<a data-toggle="tooltip"
														data-placement="top" title="Edit PaperType" data-original-title="Edit"
														href="editPaper?id=${i.paperTypeId}"><i class="bx bx-edit"></i></a>
													<a data-toggle="tooltip"
														data-placement="top" title="Delete PaperType" data-original-title="Delete"
														href="deletePaper?id=${i.paperTypeId}"><i
