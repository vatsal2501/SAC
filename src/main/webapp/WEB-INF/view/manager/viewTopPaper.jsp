...
<title>Admin | View Top Paper</title>
												...
												<td>
													<div class="d-flex align-items-center">
														<a data-toggle="tooltip"
															data-placement="top" title="Edit TopPaper" data-original-title="Edit"
															href="editTopPaper?id=${i.topPaperId}"><i class="bx bx-edit"></i></a> <a
															data-toggle="tooltip"
															data-placement="top" title="Delete TopPaper"
															data-original-title="Delete"
															href="deleteTopPaper?id=${i.topPaperId}"><i
